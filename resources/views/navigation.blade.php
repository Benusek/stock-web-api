<aside class="bg-gray-900 p-6 w-full md:w-60 lg:w-64 xl:w-72 sticky top-0 z-99">
    <div class="sticky top-6">
        ...
        <nav id="nav-panel" class="md:!flex flex-col gap-3 text-white md:mt-5">
            ...
            <a href="{{ route('logout') }}" class="flex gap-3 items-center px-3 py-2 rounded-lg hover:bg-gray-800 transition">
